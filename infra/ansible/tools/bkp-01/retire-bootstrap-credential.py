#!/usr/bin/env python3
"""bucket 생성용 BKP-01 bootstrap credential을 canonical 입력에서 제거한다."""
...
def main() -> None:
    ...
    descriptor, temporary_name = tempfile.mkstemp(
        prefix=".bkp-01-", suffix=".json", dir=args.input.parent
    )
    ...
    print(f"BKP-01 bootstrap credential 제거 완료: {args.input} (값 미출력)")
