...
- [`netbird-warpgate-native-backup.md`](netbird-warpgate-native-backup.md) — 2026-08-14 `BKP-08`에서 NetBird·Warpgate native SQLite snapshot, 전용 S3 bucket/identity, systemd timer, 격리 복원 검증 및 재부팅 영속성을 검증한 절차
...
- [`falco-runtime-response.md`](falco-runtime-response.md) — `FALCO-01`의 탐지 확인·read-only 조사·사람 승인형 격리/복구·rollback 대응 초안
