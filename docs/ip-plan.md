...
| `object-admin.imcherry5778.xyz` | service alias | SeaweedFS admin 웹 UI | Pomerium + 자체 로그인; `/platform-privileged`만 허용 | Unbound alias → `k3s-01`(`10.10.20.10`) 등록(S3-02); Pomerium이 k3s-01→object-01 TCP 23646(자체 TLS)로 전달, 내부 AAAA·공개 A/AAAA 0건 |
