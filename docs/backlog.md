...
|---|---|---|---|
| A — k3s/Argo 복구 | 없음 (모두 완료) | `SUPPLY-05-FIX-01` → `CI-01-FIX-01` → `OBS-20` → `POL-03` → `SUPPLY-05-FIX-02` → `SUPPLY-05-FIX-03` → `UPDATE-02` → `OPS-DRIFT-01` | 개발은 병렬 가능하지만 `ARGO-ROOT` 획득·라이브 검증·merge는 이 순서로 직렬화 |
