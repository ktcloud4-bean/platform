...
| `OBS-06 READY` | Data Protection & Backup Pipelines 대시보드 구축 (`gitops/apps/obs/`) | `OBS-05` | 없음 | 관측·백업 | `obs-06-backup-pipelines` ConfigMap 선언 및 Grafana 마운트, Velero 백업 성공률·SeaweedFS S3 용량/일일 증가율·AWS S3 오프사이트 헬스 시각화, Argo child `obs` `Synced/Healthy` |
