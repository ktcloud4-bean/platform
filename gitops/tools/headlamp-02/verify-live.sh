...
readonly root_target_revision=${HEADLAMP02_ROOT_TARGET_REVISION:-main}
readonly headlamp_target_revision=${HEADLAMP02_HEADLAMP_TARGET_REVISION:-main}
readonly pomerium_target_revision=${HEADLAMP02_POMERIUM_TARGET_REVISION:-main}
...
node "${repo_root}/gitops/tools/headlamp-02/browser-verify.test.js"
for required in \
...
for expected in \
  ...
  "headlamp|Synced|Healthy|${headlamp_target_revision}" \
  "pomerium|Synced|Healthy|${pomerium_target_revision}" \
